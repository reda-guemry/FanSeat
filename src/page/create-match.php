        ...
        <div class="flex items-center justify-between">
            <div>
                <nav class="text-sm mb-4">
                    <a href="/sports-ticketing/organizer/dashboard.php" class="text-purple-200 hover:text-white transition">
        ...
        <div class="bg-white rounded-3xl shadow-2xl p-8 animate-scale-in">
            <form id="createMatchForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="relative mb-12">
                    ...
                    <div class="grid grid-cols-4 gap-4 relative z-10">
                        ...
                        <div class="flex flex-col items-center step-item" data-step="1">
                            <div class="w-12 h-12 rounded-full bg-purple-600 text-white flex items-center justify-center font-bold mb-2 shadow-lg transition-all duration-300 step-circle">
                                1
                            </div>
                        ...
                        <div class="flex flex-col items-center step-item" data-step="2">
                            <div class="w-12 h-12 rounded-full bg-gray-300 text-gray-600 flex items-center justify-center font-bold mb-2 shadow-lg transition-all duration-300 step-circle">
                                2
                            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 border-2 border-purple-200">
                            ...
                            <div class="flex flex-col items-center mb-6">
                                <div class="w-32 h-32 rounded-full bg-white border-4 border-purple-300 flex items-center justify-center mb-4 transition overflow-hidden" id="logo1Preview">
                        ...
                        <!-- VS Separator -->
                        <div class="hidden lg:flex absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                            <div class="bg-gradient-to-r from-purple-600 to-pink-600 text-white font-black text-4xl px-8 py-4 rounded-2xl shadow-2xl">
                                VS
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-pink-50 to-pink-100 rounded-2xl p-6 border-2 border-pink-200">
                            ...
                            <div class="flex flex-col items-center mb-6">
                                <div class="w-32 h-32 rounded-full bg-white border-4 border-pink-300 flex items-center justify-center mb-4 transition overflow-hidden" id="logo2Preview">
                    ...
                    <div class="bg-gradient-to-br from-purple-50 to-white rounded-2xl p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="total_places" id="totalPlaces" min="100" max="2000" value="2000" required
                                       class="w-full px-4 py-3 border-2 border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all">
                        ...
                        <div>
                            ...
                            <select name="competition" id="competition"
                                ...
                                <option value="botola">Botola Pro</option>
                                <option value="coupe-trone">Coupe du Trône</option>
                                <option value="caf">CAF Champions League</option>
                                <option value="caf-conf">CAF Confederation Cup</option>
                ...
                <div class="form-step hidden" id="step3">
                    ...
                    <p class="text-gray-600 mb-8">Définissez jusqu'à 3 catégories de places avec leurs prix respectifs.</p>

                    <div class="space-y-6" id="categoriesContainer">
                        <!-- Category 1: VIP -->
                        <div class="bg-gradient-to-r from-red-50 to-pink-50 rounded-2xl p-6 border-2 border-red-200" data-category="1">
                            <div class="flex items-center justify-between mb-6">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 bg-red-600 text-white rounded-lg flex items-center justify-center font-bold mr-3">
                                        1
                                    </div>
                                ...
                                <label class="flex items-center cursor-pointer">
                                    <input type="checkbox" name="category1_enabled" value="1" checked disabled class="sr-only">
                                    <div class="w-14 h-8 bg-red-600 rounded-full relative">
                                        <div class="w-6 h-6 bg-white rounded-full absolute top-1 right-1 transition-all"></div>
                                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="category1_name" class="category-name w-full px-4 py-3 border-2 border-red-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" value="VIP" required>
                                </div>
                                <div>
                                    <label class="block text-gray-700 font-semibold mb-2">Prix (MAD) <span class="text-red-500">*</span></label>
                                    <input type="number" name="category1_price" class="category-price w-full px-4 py-3 border-2 border-red-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" min="1" placeholder="500" required>
                                </div>
                                <div>
                                    <label class="block text-gray-700 font-semibold mb-2">Places <span class="text-red-500">*</span></label>
                                    <input type="number" name="category1_places" class="category-places w-full px-4 py-3 border-2 border-red-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" min="1" placeholder="200" required>
                                </div>
                            </div>
                            
                            <div>
                                <label class="block text-gray-700 font-semibold mb-2">Description</label>
                                <input type="text" name="category1_desc" class="w-full px-4 py-3 border-2 border-red-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" placeholder="Ex: Accès lounge, sièges premium, restauration incluse">
                            </div>
                        </div>

                        <!-- Category 2: Tribune -->
                        <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border-2 border-green-200 category-card" data-category="2">
                            <div class="flex items-center justify-between mb-6">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 bg-green-600 text-white rounded-lg flex items-center justify-center font-bold mr-3">
                                        2
                                    </div>
                                ...
                                <label class="flex items-center cursor-pointer">
                                    <input type="checkbox" name="category2_enabled" value="1" checked class="category-toggle sr-only">
                                    <div class="toggle-bg w-14 h-8 bg-green-600 rounded-full relative">
                                        <div class="toggle-dot w-6 h-6 bg-white rounded-full absolute top-1 right-1 transition-all"></div>
                                    </div>
                            ...
                            <div class="category-content">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input type="text" name="category2_name" class="category-name w-full px-4 py-3 border-2 border-green-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" value="Tribune">
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 font-semibold mb-2">Prix (MAD)</label>
                                        <input type="number" name="category2_price" class="category-price w-full px-4 py-3 border-2 border-green-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" min="1" placeholder="200">
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 font-semibold mb-2">Places</label>
                                        <input type="number" name="category2_places" class="category-places w-full px-4 py-3 border-2 border-green-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" min="1" placeholder="800">
                                    </div>
                                </div>
                                
                                <div>
                                    <label class="block text-gray-700 font-semibold mb-2">Description</label>
                                    <input type="text" name="category2_desc" class="w-full px-4 py-3 border-2 border-green-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Ex: Vue dégagée sur le terrain">
                                </div>
                            </div>
                        </div>

                        <!-- Category 3: Pelouse -->
                        <div class="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl p-6 border-2 border-yellow-200 category-card" data-category="3">
                            <div class="flex items-center justify-between mb-6">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 bg-yellow-600 text-white rounded-lg flex items-center justify-center font-bold mr-3">
                                        3
                                    </div>
                                ...
                                <label class="flex items-center cursor-pointer">
                                    <input type="checkbox" name="category3_enabled" value="1" checked class="category-toggle sr-only">
                            ...
                            <div class="category-content">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    <div>
                                        <label class="block text-gray-700 font-semibold mb-2">Nom</label>
                                        <input type="text" name="category3_name" class="category-name w-full px-4 py-3 border-2 border-yellow-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500" value="Pelouse">
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 font-semibold mb-2">Prix (MAD)</label>
                                        <input type="number" name="category3_price" class="category-price w-full px-4 py-3 border-2 border-yellow-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500" min="1" placeholder="100">
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 font-semibold mb-2">Places</label>
                                        <input type="number" name="category3_places" class="category-places w-full px-4 py-3 border-2 border-yellow-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500" min="1" placeholder="1000">
                                    </div>
                                </div>
                                
                                <div>
                                    <label class="block text-gray-700 font-semibold mb-2">Description</label>
                                    <input type="text" name="category3_desc" class="w-full px-4 py-3 border-2 border-yellow-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500" placeholder="Ex: Places économiques">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-step hidden" id="step4">
                    ...
                    <!-- Match Preview -->
                    <div class="bg-gradient-to-br from-purple-600 to-indigo-700 rounded-3xl p-8 text-white mb-8 shadow-2xl">
                        <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="grid grid-cols-3 gap-8 items-center mb-6">
                            <div class="text-center">
                                <div class="w-24 h-24 bg-white rounded-full mx-auto mb-4 flex items-center justify-center overflow-hidden" id="previewLogo1">
                            ...
                            <div class="text-center">
                                <div class="w-24 h-24 bg-white rounded-full mx-auto mb-4 flex items-center justify-center overflow-hidden" id="previewLogo2">
                            ...
                            <table class="w-full">
                                <thead class="bg-purple-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-4 text-left font-semibold text-purple-900">Revenus potentiels</th>
                                    </tr>
                                </thead>
                    ...
                    <div class="bg-purple-50 border-2 border-purple-200 rounded-2xl p-6">
                        <label class="flex items-start cursor-pointer">
                            <input type="checkbox" id="termsAccept" required class="mt-1 mr-3 w-5 h-5 text-purple-600 border-2 border-purple-300 rounded focus:ring-purple-500">
                            <span class="text-gray-700">
                                J'accepte les <a href="#" class="text-purple-600 font-semibold hover:underline">conditions générales</a> et confirme que les informations sont exactes.
                            </span>
                        </label>
                    </div>
                </div>
