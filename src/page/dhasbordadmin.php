...
<!-- Hero Section -->
<section class="bg-gradient-to-r from-purple-700 to-purple-900 text-white py-12 animate-fade-in-up">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="card-smooth bg-white rounded-2xl shadow-lg p-6 border-l-4 border-purple-600 animate-fade-in-up" style="animation-delay: 0.1s">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-gradient-to-br from-purple-500 to-purple-700 w-16 h-16 rounded-xl flex items-center justify-center shadow-lg">
            ...
            <div class="card-smooth bg-white rounded-2xl shadow-lg p-6 border-l-4 border-pink-600 animate-fade-in-up" style="animation-delay: 0.2s">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-gradient-to-br from-pink-500 to-pink-700 w-16 h-16 rounded-xl flex items-center justify-center shadow-lg">
            ...
            <div class="card-smooth bg-white rounded-2xl shadow-lg p-6 border-l-4 border-indigo-600 animate-fade-in-up" style="animation-delay: 0.3s">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-gradient-to-br from-indigo-500 to-indigo-700 w-16 h-16 rounded-xl flex items-center justify-center shadow-lg">
            ...
            <div class="card-smooth bg-white rounded-2xl shadow-lg p-6 border-l-4 border-green-600 animate-fade-in-up" style="animation-delay: 0.4s">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-gradient-to-br from-green-500 to-green-700 w-16 h-16 rounded-xl flex items-center justify-center shadow-lg">
                    ...
                    <?php foreach ($recent_users as $user): ?>
                        <div class="flex items-center justify-between p-4 bg-purple-50 rounded-xl hover:bg-purple-100 transition-all">
                            <div class="flex items-center">
                                <div class="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-700 rounded-full flex items-center justify-center text-white font-bold text-lg mr-4 shadow-md">
...
<section class="py-12 bg-white">
    <div class="container mx-auto px-4">
        <div class="bg-gradient-to-r from-purple-700 to-purple-900 rounded-2xl shadow-2xl p-8 text-white">
