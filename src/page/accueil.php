...
<section class="bg-gradient-to-r from-purple-600 via-purple-700 to-indigo-800 text-white py-20">
...
<section class="py-12 bg-white">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="text-center p-6 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg hover:shadow-lg transition-shadow duration-300">
                <i class="fas fa-futbol text-4xl text-purple-600 mb-4"></i>
                <h3 class="text-3xl font-bold text-gray-800"><?php echo count($matches); ?>+</h3>
                <p class="text-gray-600">Matchs Disponibles</p>
            </div>
            <div class="text-center p-6 bg-gradient-to-r from-indigo-50 to-indigo-100 rounded-lg hover:shadow-lg transition-shadow duration-300">
            ...
            <div class="text-center p-6 bg-gradient-to-r from-violet-50 to-violet-100 rounded-lg hover:shadow-lg transition-shadow duration-300">
                <i class="fas fa-ticket-alt text-4xl text-violet-600 mb-4"></i>
                <h3 class="text-3xl font-bold text-gray-800"><?= Ticket::getCountTicket() ?></h3>
                <p class="text-gray-600">Billets Vendus</p>
            </div>
            <div class="text-center p-6 bg-gradient-to-r from-fuchsia-50 to-fuchsia-100 rounded-lg hover:shadow-lg transition-shadow duration-300">
                <i class="fas fa-star text-4xl text-fuchsia-600 mb-4"></i>
                <h3 class="text-3xl font-bold text-gray-800"><?= Comment::avgOfAllComment() ?></h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <?php else: ?>
                <?php foreach ($matches as $match): ?>
                    <div class="card-hover bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <!-- Badge de statut -->
                        <div class="bg-gradient-to-r from-purple-500 to-indigo-600 text-white px-4 py-2 text-center">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-6">
                                <a href="/fan-seat/src/page/match-details.php?id=<?php echo $match->getId(); ?>"
                                    class="block w-full bg-gradient-to-r from-purple-600 to-indigo-700 text-white text-center py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-indigo-800 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
...
<!-- Call to Action -->
<section class="py-16 bg-gradient-to-r from-purple-600 via-purple-700 to-indigo-800 text-white">
    <div class="container mx-auto px-4 text-center">
        ...
        <?php if (!isset($_SESSION['user_id'])): ?>
            <a href="/sports-ticketing/public/register.php"
                class="bg-white text-purple-700 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-purple-50 transition-all duration-300 inline-block shadow-lg hover:shadow-xl transform hover:-translate-y-1">
