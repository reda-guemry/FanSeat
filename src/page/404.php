        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="mb-8">
                <svg class="mx-auto" width="200" height="200" viewBox="0 0 200 200">
                    <circle cx="100" cy="100" r="80" fill="none" stroke="#3b82f6" stroke-width="4" stroke-dasharray="502" stroke-dashoffset="502" opacity="0.3">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="/sports-ticketing/public/matches.php" class="bg-white border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition inline-block">
            ...
            <div class="mt-12 p-6 bg-white rounded-lg shadow-md">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <a href="/sports-ticketing/public/matches.php" class="text-blue-600 hover:text-blue-700 transition">
                        <i class="fas fa-calendar block text-2xl mb-2"></i>
                        Matchs
                    </a>
                    <a href="/sports-ticketing/public/contact.php" class="text-blue-600 hover:text-blue-700 transition">
                        <i class="fas fa-envelope block text-2xl mb-2"></i>
                        Contact
                    </a>
                    <a href="/sports-ticketing/public/help.php" class="text-blue-600 hover:text-blue-700 transition">
            ...
            <?php if (isset($_SERVER['REQUEST_URI'])): ?>
                <div class="mt-6 text-sm text-gray-500">
                    <p>URL demandée: <code class="bg-gray-200 px-2 py-1 rounded"><?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?></code></p>
                </div>
            <?php endif; ?>
        </div>
    </div>
